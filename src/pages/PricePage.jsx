...
function PricePage() {
  return (
    <div className='prices-page text-white'>
        <div className="prices-top flex flex-col md:flex-row gap-10 md:gap-40 px-4 md:px-20 pb-10 md:pb-20 justify-center">
        ...
        <div className="prices-bottom w-full px-4 md:px-20 border-t-2 border-gray-500 text-center mx-auto bg-clip-text text-transparent drop-shadow-2xl bg-gradient-to-b from-white/80 to-white/20">
            <h4 className='text-xl md:text-3xl pt-4 md:pt-5'>And with unforgettable experience and Abundant knowledge!</h4>
        </div>
    </div>
  )
}
